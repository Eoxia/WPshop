<?php
/**
 * La vue principale de la page des commandes.
 *
 * @package   WPshop
 ...
 * @var string  $dolibarr_create_order L'url de la liste des commandes sur Dolibarr.
...
<div class="wrap wpeo-wrap">
	<h2><?php esc_html_e( 'Orders', 'wpshop' ); ?>
		<a href="<?php echo esc_attr( $dolibarr_url . $dolibarr_create_order ); ?>" target="_blank" class="wpeo-button button-main"><?php esc_html_e( 'Add', 'wpshop' ); ?></a>
	</h2>
