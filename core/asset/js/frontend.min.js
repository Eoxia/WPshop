 ...
 * @since 2.0.0
 */
window.eoxiaJS.wpshopFrontend.wishlist = {};
 ...
 * @since 2.0.0
 */
window.eoxiaJS.wpshopFrontend.wishlist.init = function() {
	window.eoxiaJS.wpshopFrontend.wishlist.event();
};

window.eoxiaJS.wpshopFrontend.wishlist.event = function() {

};

window.eoxiaJS.wpshopFrontend.wishlist.addWishlistSuccess = function ( triggeredElement, response ) {
	triggeredElement.closest( '.wps-list-quotation' ).find( '.list-wishlist' ).prepend( response.data.view );
};
