...
window.eoxiaJS.gallery.checkIsFeaturedMedia = function( fileID ) {
	...
	if ( mainFeaturedMediaID == fileID ) {
		jQuery( '.wpeo-gallery .featured-thumbnail i' ).removeClass( 'far' );
		jQuery( '.wpeo-gallery .featured-thumbnail i' ).addClass( 'fas' );
	} else {
		jQuery( '.wpeo-gallery .featured-thumbnail i' ).removeClass( 'fas' );
		jQuery( '.wpeo-gallery .featured-thumbnail i' ).addClass( 'far' );
	}
};
